            ...
            <BrowserRouter>
                <div className="wrapper">
                    ...
                    <Routes>
                        ...
                        <Route
                            path="/market/update/:posting"
                            element={<MarketUpdate />}
                        />
                        <Route
                            path="/market/detail/:posting"
                        ...
                        <Route
                            path="/place/detail/:search?/:category?"
                            element={<Place_Detail />}
                        />
                        ...
                        <Route
                            path="/admin/reports/:choice/:search"
                            element={<Reports />}
                        />
